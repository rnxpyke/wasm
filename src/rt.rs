...
use crate::{
    instance::{FuncAddr, FuncInst, ModuleInst, Store},
    repr::{self, Inst, LocalIdx, MemArg, ResultType},
};
        ...
        for inst in instructions {
            ...
            match inst {
                ...
                Inst::I32Load(memarg) => {
                    ...
                    const N: usize = 32;
                    if ea + N / 8 > mem.len() {
                        return Err(Exception::Runtime(Error::OobAccess {
                            addr: ea,
                            len: N / 8,
                        }));
                    }
